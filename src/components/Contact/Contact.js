...
function Contact() {
  ...
  return (
    <ContactWrapper id="contact">
      ...
      <h2>Always happy to collaborate when I have the time. If you think my skills could be of use or just want to grab a coffee, get in touch ✌️ .</h2>
      <ContactBox>
        <LeftContent>
        ...
        <ContactForm
          noValidate
          action="https://formspree.io/matthew.schulz.19@ucl.ac.uk"
          method="POST"
        >
